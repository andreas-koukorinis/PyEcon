...
# /// Write out ///
out = r"M:\Takashi SHIONO\Numerical\ACE\Baseline\out.dump"
# opened = open(out,'w');pickle.dump(Data,opened);opened.close()

# /// Load ///
# opened = open(out);Data=pickle.load(opened);opened.close();
